...
def transform_to_onnx(cfgfile, weightfile, batch_size=1, onnx_file_name=None):
    ...
    if dynamic:
        ...
        dynamic_axes = {"input": {0: "batch_size", 2: "height", 3: "width"}, "boxes": {0: "batch_size",1: 'anchors'}, "confs": {0: "batch_size", 1: 'anchors'}}
        # Export the model
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weightfile', help='weight file path')
